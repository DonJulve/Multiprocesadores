...
0000000000401290 <scale_shift>:
{
  ...
  401295:	48 83 e4 e0          	and    $0xffffffffffffffe0,%rsp
    init();
  ...
  4012a5:	41 bc 00 00 f0 00    	mov    $0xf00000,%r12d
{
  ...
  4012b3:	48 83 ec 38          	sub    $0x38,%rsp
    init();
  4012b7:	e8 74 ff ff ff       	call   401230 <init>
    start_t = get_wall_time();
  4012bc:	31 c0                	xor    %eax,%eax
  4012be:	e8 fd fe ff ff       	call   4011c0 <get_wall_time>
  4012c3:	c4 e2 7d 18 1d 34 0e 	vbroadcastss 0xe34(%rip),%ymm3        # 402100 <__dso_handle+0xf8>
  4012ca:	00 00 
  4012cc:	c4 e2 7d 18 15 4b 0e 	vbroadcastss 0xe4b(%rip),%ymm2        # 402120 <__dso_handle+0x118>
  4012d3:	00 00 
  ...
  4012e5:	0f 1f 00             	nopl   (%rax)
            x[i] = alpha*x[i] + beta;
  4012e8:	c5 e4 59 00          	vmulps (%rax),%ymm3,%ymm0
  4012ec:	48 83 c0 20          	add    $0x20,%rax
  4012f0:	c5 fc 58 c2          	vaddps %ymm2,%ymm0,%ymm0
  4012f4:	c5 fc 29 40 e0       	vmovaps %ymm0,-0x20(%rax)
        for (unsigned int i = 0; i < LEN; i++)
  4012f9:	48 39 c3             	cmp    %rax,%rbx
  4012fc:	75 ea                	jne    4012e8 <scale_shift+0x58>
        dummy(x, alpha, beta);
  4012fe:	c5 fa 10 0d 1a 0e 00 	vmovss 0xe1a(%rip),%xmm1        # 402120 <__dso_handle+0x118>
  401305:	00 
  401306:	c5 fa 10 05 f2 0d 00 	vmovss 0xdf2(%rip),%xmm0        # 402100 <__dso_handle+0xf8>
  40130d:	00 
  40130e:	bf 80 40 40 00       	mov    $0x404080,%edi
  401313:	c5 f8 77             	vzeroupper 
  401316:	e8 8b fe ff ff       	call   4011a6 <dummy>
    for (unsigned int nl = 0; nl < NTIMES; nl++)
  40131b:	41 83 ec 01          	sub    $0x1,%r12d
  40131f:	c5 fc 28 1d d9 0d 00 	vmovaps 0xdd9(%rip),%ymm3        # 402100 <__dso_handle+0xf8>
  401326:	00 
  401327:	c5 fc 28 15 f1 0d 00 	vmovaps 0xdf1(%rip),%ymm2        # 402120 <__dso_handle+0x118>
  40132e:	00 
  40132f:	75 af                	jne    4012e0 <scale_shift+0x50>
    end_t = get_wall_time();
  401331:	31 c0                	xor    %eax,%eax
  401333:	c5 f8 77             	vzeroupper 
  401336:	e8 85 fe ff ff       	call   4011c0 <get_wall_time>
    results(end_t - start_t, "scale_shift");
  40133b:	c5 fb 5c 45 c8       	vsubsd -0x38(%rbp),%xmm0,%xmm0
  401340:	bf 2f 20 40 00       	mov    $0x40202f,%edi
  401345:	e8 16 ff ff ff       	call   401260 <results>
    check(x);
  40134a:	bf 80 40 40 00       	mov    $0x404080,%edi
  40134f:	e8 ac fe ff ff       	call   401200 <check>
}
  401354:	48 83 c4 38          	add    $0x38,%rsp
  401358:	31 c0                	xor    %eax,%eax
  40135a:	5b                   	pop    %rbx
  40135b:	41 5a                	pop    %r10
  40135d:	41 5c                	pop    %r12
  40135f:	5d                   	pop    %rbp
  401360:	49 8d 62 f8          	lea    -0x8(%r10),%rsp
  401364:	c3                   	ret    
  401365:	66 66 2e 0f 1f 84 00 	data16 cs nopw 0x0(%rax,%rax,1)
  40136c:	00 00 00 00 
  ...
  401373:	bd 00 00 f0 00       	mov    $0xf00000,%ebp
{
  ...
  401395:	00 00 
  401397:	c4 e2 79 18 15 80 0d 	vbroadcastss 0xd80(%rip),%xmm2        # 402120 <__dso_handle+0x118>
  40139e:	00 00 
...
_mm_store_ps (float *__P, __m128 __A)
{
  *(__m128 *)__P = __A;
  ...
  4013cc:	75 ea                	jne    4013b8 <ss_intr_SSE+0x48>
        dummy(x, alpha, beta);
  4013ce:	c5 fa 10 0d 4a 0d 00 	vmovss 0xd4a(%rip),%xmm1        # 402120 <__dso_handle+0x118>
  4013d5:	00 
  4013d6:	c5 fa 10 05 22 0d 00 	vmovss 0xd22(%rip),%xmm0        # 402100 <__dso_handle+0xf8>
  4013dd:	00 
  ...
  4013f2:	00 
  4013f3:	c5 f8 28 15 25 0d 00 	vmovaps 0xd25(%rip),%xmm2        # 402120 <__dso_handle+0x118>
  4013fa:	00 
  ...
  401445:	41 bc 00 00 f0 00    	mov    $0xf00000,%r12d
{
  ...
  40146a:	00 00 
  40146c:	c4 e2 7d 18 15 ab 0c 	vbroadcastss 0xcab(%rip),%ymm2        # 402120 <__dso_handle+0x118>
  401473:	00 00 
...
_mm256_store_ps (float *__P, __m256 __A)
{
  *(__m256 *)__P = __A;
  ...
  40149c:	75 ea                	jne    401488 <ss_intr_AVX+0x58>
        dummy(x, alpha, beta);
  40149e:	c5 fa 10 0d 7a 0c 00 	vmovss 0xc7a(%rip),%xmm1        # 402120 <__dso_handle+0x118>
  4014a5:	00 
  4014a6:	c5 fa 10 05 52 0c 00 	vmovss 0xc52(%rip),%xmm0        # 402100 <__dso_handle+0xf8>
  4014ad:	00 
  4014ae:	bf 80 40 40 00       	mov    $0x404080,%edi
  ...
  4014c6:	00 
  4014c7:	c5 fc 28 15 51 0c 00 	vmovaps 0xc51(%rip),%ymm2        # 402120 <__dso_handle+0x118>
  4014ce:	00 
